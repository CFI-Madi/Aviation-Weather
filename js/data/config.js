...
const SAMPLE_METAR = {
  ...
  tokens: [
    ...
    {token:'+TSRA BR', label:'Weather', color:'#7C3AED', bg:'#F5F3FF', detail:'+ = heavy intensity. TS = thunderstorm. RA = rain. BR = mist (visibility 5/8–7 SM). Other: - (light), FG (fog <5/8), SN (snow), GR (hail), FZRA (freezing rain).'},
